...
function FriendsList({ user }) {
    ...
    return (
        <div className="w-1/2 m-auto flex flex-col justify-between p-8 transition-shadow border-2 bg-white rounded overflow-hidden shadow-slate-400 shadow-lg group">
