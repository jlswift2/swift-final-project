    ...
    return (
        <nav className="absolute top-[25%] h-1/2 w-full flex align-middle overflow-y-auto px-3 bg-gray-50 rounded dark:bg-gray-800" >
            <div className="m-auto w-full text-center">
                ...
                {user ? null 
                    : 
                    <Link to="/signup" className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                    <span className="flex-1 ml-3 whitespace-nowrap text-xl">Sign Up</span>
                    </Link>
                }
